...
object WordCountTopology {
  ...
  case class RandomSentenceSpoutT(spout: RandomSentenceSpout)
      extends StormSpoutT[String]
  class RandomSentenceSpout extends BaseRichSpout {
    ...
    override def open(
        conf: java.util.Map[String, Object],
  ...
  case class SplitSentenceBoltT(bolt: SplitSentenceBolt)
      extends StormBoltT[String, String]
  ...
  case class WordCountBoltT(bolt: WordCountBolt)
      extends StormBoltT[String, (String, Int)]
  ...
  def main(args: Array[String]): Unit = {
    ...
    val builderT = (new TopologyBuilderT(new TopologyBuilder, "")).init
      ...
      .>>>("split", new SplitSentenceBoltT(new SplitSentenceBolt), 8)(
        _.shuffleGrouping("randsentence")
      )
      .>>>("count", new WordCountBoltT(new WordCountBolt), 12)(
        _.fieldsGrouping("split", new Fields("word"))
      )
